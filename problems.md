...
1.1. Медианой конечного облака точек $X \subset \mathbb{R}^3$ назовём точку $c \in \mathbb{R}^3$, такую что любое замкнутое полупространство, содержащее $c$, содержит хотя бы четверть точек множества $X$. Докажите, что множество всех медиан образует непустой выпуклый многогранник. Центр тяжести многогранника всех медиан данного облака точек назовём _главной медианой_. Ясно, что главная медиана непрерывно зависит от $X$.
